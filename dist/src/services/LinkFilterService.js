...
exports.LinkFilterService = void 0;
class LinkFilterService {
    /**
     * Filtra e limpa links usando LLM para remover sites inadequados
     */
    static async filtrarLinksComLLM(links, termoBusca, limite) {
        ...
        try {
            ...
            const prompt_sistema = ("Você é um especialista em identificação e normalização de sites de e-commerce e serviços. Analise os links e retorne URLs limpos de sites comerciais adequados para busca de produtos.\n" +
     ...
     */
    static filtroBasicoLinks(links, limite) {
        return links
            .map(link => ({
            ...link,
            ...
            const isEcommerce = url.includes('loja') ||
                url.includes('shop') ||
                url.includes('store') ||
                title.includes('loja') ||
            ...
            const isNotEcommerce = url.includes('wikipedia') ||
...
exports.LinkFilterService = LinkFilterService;
//# sourceMappingURL=LinkFilterService.js.map