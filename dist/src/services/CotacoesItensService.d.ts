...
declare class CotacoesItensService {
     ...
     */
    fulfillPlaceholderWithAnalysis(cotacaoId: number, placeholderId: number, produto: any | null, quantidade: number, produtoId?: number, relatorio?: any, tipoBusca?: 'principal' | 'reforco'): Promise<number | null>;
    /**
