...
exports.BuscaAutomatica = void 0;
...
class BuscaAutomatica {
     ...
     */
    async buscarProdutosMultiplosSites(searchTerm, websites, numResultsPerSite = 5) {
        const promises = websites.map(website => this.buscarProdutos({
            searchTerm,
            website,
     ...
     */
    filtrarPorPreco(produtos, precoMin, precoMax) {
        return produtos.filter(produto => {
            ...
            if (precoNumerico === null)
                return true; // Se não conseguir extrair, inclui o produto
            if (precoMin !== undefined && precoNumerico < precoMin)
                return false;
            if (precoMax !== undefined && precoNumerico > precoMax)
                return false;
            return true;
        });
    }
     ...
     */
    criarRespostaBusca(produtos, sites, filtros, tempoBusca) {
        return {
            produtos,
...
exports.BuscaAutomatica = BuscaAutomatica;
//# sourceMappingURL=BuscaAtomatica.js.map