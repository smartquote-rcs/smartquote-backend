...
exports.ExemploIntegracaoController = void 0;
exports.exemploCreateQuote = exemploCreateQuote;
exports.exemploUpdateProduct = exemploUpdateProduct;
exports.exemploDeleteSupplier = exemploDeleteSupplier;
exports.exemploUserLogin = exemploUserLogin;
exports.exemploStatusChange = exemploStatusChange;
exports.exemploConsultarLogsPorUsuario = exemploConsultarLogsPorUsuario;
exports.exemploConsultarLogsPorAcao = exemploConsultarLogsPorAcao;
exports.exemploHistoricoRegistro = exemploHistoricoRegistro;
exports.exemploFiltrosAvancados = exemploFiltrosAvancados;
exports.exemploEstatisticas = exemploEstatisticas;
...
// ============================================
async function exemploCreateQuote() {
...
// ============================================
async function exemploUpdateProduct() {
    const userId = 'user-uuid-here';
    const productId = 456;
    await auditLogService.create({
        user_id: userId,
...
// ============================================
async function exemploDeleteSupplier() {
    const userId = 'user-uuid-here';
...
// ============================================
async function exemploUserLogin() {
    const userId = 'user-uuid-here';
    await auditLogService.create({
        user_id: userId,
        action: 'USER_LOGIN',
...
// ============================================
async function exemploStatusChange() {
    const userId = 'user-uuid-here';
    const quoteId = 123;
    await auditLogService.create({
        user_id: userId,
...
// ============================================
async function exemploConsultarLogsPorUsuario() {
    const userId = 'user-uuid-here';
...
// ============================================
async function exemploConsultarLogsPorAcao() {
...
// ============================================
async function exemploHistoricoRegistro() {
...
async function exemploEstatisticas() {
    const stats = await auditLogService.getStatistics('2025-01-01T00:00:00Z', '2025-12-31T23:59:59Z');
...
// ============================================
class ExemploIntegracaoController {
    async createQuote(req, res) {
        ...
        try {
            ...
            await logAction(userId, 'CREATE_QUOTE', 'cotacoes', newQuote.id, {
    ...
    async updateQuote(req, res) {
        ...
        try {
            ...
            await logAction(userId, 'UPDATE_QUOTE', 'cotacoes', quoteId, {
    ...
    async createQuoteInDB(data) {
        return { id: 123, ...data };
    }
    async getQuoteById(id) {
        return { id, status: 'pending' };
    }
    async updateQuoteInDB(id, data) {
        return { id, ...data };
    }
}
exports.ExemploIntegracaoController = ExemploIntegracaoController;
// ============================================
...
runExamples();
*/
//# sourceMappingURL=ExemploAuditLogs.js.map