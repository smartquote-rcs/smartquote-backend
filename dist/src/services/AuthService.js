...
class AuthService {
    ...
    async signIn({ email, password }) {
        ...
        if (userCheckError || !userCheck) {
            throw new Error("Email não encontrado ou incorreto. Verifique se digitou exatamente como cadastrado.");
        }
        console.log(`✅ Email validado: ${email} existe na tabela users`);
