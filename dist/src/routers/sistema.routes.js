...
const SistemaController_1 = __importDefault(require("../controllers/SistemaController"));
const authMiddleware_1 = require("../middleware/authMiddleware");
const sistemaRouter = (0, express_1.Router)();
/**
 * @swagger
 * /sistema:
 *   get:
 ...
 */
sistemaRouter.get('/', SistemaController_1.default.getSistema);
/**
 * @swagger
 * /sistema:
 *   post:
 ...
 *         description: Erro interno do servidor
 */
sistemaRouter.post('/', authMiddleware_1.authMiddleware, SistemaController_1.default.upsertSistema);
/**
 * @swagger
 * /sistema:
 *   patch:
 ...
 *         description: Erro interno do servidor
 */
sistemaRouter.patch('/', authMiddleware_1.authMiddleware, SistemaController_1.default.updateSistema);
exports.default = sistemaRouter;
//# sourceMappingURL=sistema.routes.js.map