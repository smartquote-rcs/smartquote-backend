            ...
            if (todosProdutos.length === 0) {
                ...
                if (!(urls_add && Array.isArray(urls_add) && urls_add.length > 0)) {
                    ...
                    try {
                        ...
                        const response = await axios_1.default.get(`${baseUrl}/api/busca-automatica/procurarSites`, {
                            params: {
                                q: termo,
