...
exports.exemploUso = exemploUso;
exports.exemploComAxios = exemploComAxios;
exports.removerFaltanteRobusto = removerFaltanteRobusto;
// Exemplo 1: Remover por índice
async function removerFaltantePorIndice(cotacaoId, index) {
    try {
...
async function removerFaltantePorQuery(cotacaoId, query) {
    try {
        const response = await fetch(`/api/cotacoes/${cotacaoId}/remove-faltante`, {
            method: 'POST',
            headers: {
...
async function removerFaltantePorNome(cotacaoId, nome) {
    try {
        const response = await fetch(`/api/cotacoes/${cotacaoId}/remove-faltante`, {
            method: 'POST',
            headers: {
...
async function removerFaltanteRobusto(cotacaoId, criterios) {
    try {
...
//# sourceMappingURL=ExemploRemoveFaltantes.js.map