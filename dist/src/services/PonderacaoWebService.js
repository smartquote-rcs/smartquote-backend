...
exports.PonderacaoWebService = void 0;
class PonderacaoWebService {
    /**
     * Adiciona ponderação de busca externa para cada faltante usando LLM
     */
    static async ponderarWebLLM(faltantes) {
...
`;
            ...
            const faltantesComPonderacao = faltantes.map((faltante, index) => {
                const ponderacaoItem = ponderacoes.find(p => p.id === faltante.id || p.id === index);
     ...
     */
    static ponderacaoPadrao(faltantes) {
...
exports.PonderacaoWebService = PonderacaoWebService;
exports.default = PonderacaoWebService;
//# sourceMappingURL=PonderacaoWebService.js.map